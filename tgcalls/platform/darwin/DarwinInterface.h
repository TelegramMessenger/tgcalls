...
public:
    ...
    std::shared_ptr<VideoCapturer> makePlatformVideoCapturer(rtc::scoped_refptr<webrtc::VideoTrackSourceInterface> source, bool useFrontCamera, std::function<void(bool)> isActiveUpdated) override;
