 ...
 */
#ifndef TGCALLS_CUSTOM_DCSCTP_SOCKET_H_
#define TGCALLS_CUSTOM_DCSCTP_SOCKET_H_
...
class CustomDcSctpSocket : public DcSctpSocketInterface {
 public:
  ...
  CustomDcSctpSocket(absl::string_view log_prefix,
               DcSctpSocketCallbacks& callbacks,
               std::unique_ptr<PacketObserver> packet_observer,
               const DcSctpOptions& options);

  CustomDcSctpSocket(const CustomDcSctpSocket&) = delete;
 ...
 private:
  ...
  static constexpr absl::string_view ToString(CustomDcSctpSocket::State state);
...
#endif  // TGCALLS_CUSTOM_DCSCTP_SOCKET_H_
