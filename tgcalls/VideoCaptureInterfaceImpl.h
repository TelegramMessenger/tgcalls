...
private:
	...
	std::weak_ptr<webrtc::VideoSinkInterface<webrtc::VideoFrame>> _currentUncroppedSink;
...
public:
	...
	void setOutput(std::shared_ptr<webrtc::VideoSinkInterface<webrtc::VideoFrame>> sink) override;
