#ifndef TGCALLS_INSTANCEV4_0_0_IMPL_H
#define TGCALLS_INSTANCEV4_0_0_IMPL_H
...
class InstanceV4_0_0Impl final : public Instance {
public:
    explicit InstanceV4_0_0Impl(Descriptor &&descriptor);
    ~InstanceV4_0_0Impl() override;
...
private:
    ...
    std::unique_ptr<ThreadLocalObject<InstanceV4_0_0ImplInternal>> _internal;
