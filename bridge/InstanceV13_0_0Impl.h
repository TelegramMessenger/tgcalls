#ifndef TGCALLS_INSTANCEV13_0_0_IMPL_H
#define TGCALLS_INSTANCEV13_0_0_IMPL_H
...
class InstanceV13_0_0Impl final : public Instance {
public:
    explicit InstanceV13_0_0Impl(Descriptor &&descriptor);
    ~InstanceV13_0_0Impl() override;
...
private:
    ...
    std::unique_ptr<ThreadLocalObject<InstanceV13_0_0ImplInternal>> _internal;
